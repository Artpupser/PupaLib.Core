...
![NuGet](https://img.shields.io/nuget/v/PupaLib.Core.svg?style=for-the-badge)
![.NET](https://img.shields.io/badge/.NET-10.0-blue?style=for-the-badge)


#### [PupaLib.Core](https://www.nuget.org/packages/PupaLib.Core) performance core, for easy develop projects on csharp. 📈

<img src="https://github.com/Artpupser/PupaLib.Core/blob/main/assets/banner.jpg" style="border-radius: 20px; max-height: 500px">
